...
{
    DirectionalLight::DirectionalLight(Entity* entity, uint32_t size, float cameraSize) : OrthographicCamera(entity, cameraSize, glm::vec2(0.01, 50)), Light(entity, GetWindow()->AssetManager.Create<Asset::Texture2D>(size, size, Asset::TextureType::DEPTH_32F, 1, Asset::TextureFilterMode::LINEAR))
    {
